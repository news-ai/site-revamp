  ...
  render() {
    ...
    return (
      <div style={containerStyle} >
        ...
        style={{color: currentPage === 0 ? 'lightgrey' : 'grey', cursor: 'pointer', userSelect: 'none'}}
        onClick={this.onPrev}
        aria-hidden='true'
        />
        ...
        style={{color: currentPage + 1 === setSize ? 'lightgrey' : 'grey', cursor: 'pointer', userSelect: 'none'}}
        onClick={this.onNext}
        aria-hidden='true'
        />
      </div>
